// ─── ReportsDateRangeForm.jsx ─────────────────────────────────────────────────
// Date-range search for the Reports & Analytics page. Same pattern as
// FinancialsDateRangeForm.jsx — both dates required, one-click "This Month"
// reset back to the default range.
// ──────────────────────────────────────────────────────────────────────────────

import { useState } from "react";
import { Search, RotateCcw } from "lucide-react";
import styles from "./ReportsDateRangeForm.module.css";
...
function ReportsDateRangeForm({ startDate, endDate, onApply }) {
  ...
  return (
    <div className={styles.wrap}>
      <form
        ...
        aria-label="Search reports by date range"
      >
...
export default ReportsDateRangeForm;
